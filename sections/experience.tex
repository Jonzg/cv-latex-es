...
\innerlist{
    ...
    \entry{Investigación comparativa de ML clásico vs. ML cuántico (QML) en clasificación y regresión molecular, implementando pipelines con SKLearn, Qiskit y MLflow. Entrenamiento y evaluación de modelos SVM, RF y MLP frente a sus análogos cuánticos (QSVM, circuitos variacionales y QNNs). Análisis de robustez ante escasez de datos y ruido y escalabilidad de circuitos variacionales para determinar umbrales de viabilidad y ROI de la computación cuántica en entornos industriales.}
}
